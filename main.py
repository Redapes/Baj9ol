#by : S7L DLJ comeantary BOT TOP ¹      # ======================== IMPORTS =======================
...
[1E90FF]ＤＥＶ   [FF0000]@dljyta
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FF0000]_ _ _ X ³ _ _ _ _  
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[9400D3]M A D E B Y [FF0000]DLJ comeantary BOT 
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] ＦＯＬＬＯＷ    ＭＥ   ＩＮ   [87CEEB]TELEGRAM: [FF0000]@dljyta
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
    fields = {
    1: 5,
    2: {
...
[b][c][00FF00]Wʟᴄ Tᴏ DLJ comeantary Bᴏᴛ Hᴇʀᴇ 
❀️ [B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[FFFFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]DLJ comeantary Tᴄᴘ Bᴏᴛ [00FFFF]║
...
"""
                        ...
                        if inPuTMsG.strip() == "@admin":
                            ...
                            admin_message = """
[C][B][00FFFF]★☆★☆★☆★☆★
[B][C][FF0000]BY : DLJ comeantary BOT 
[B][C][FF0000]Tele : @dljyta
[B][C][FF0000]YouTube: @dljyta
[B][C][FF0000]insta : @dljyta
[B][C][FF0000]TIK : @dljyta
[FFFFFF]✳️ سورس البوت قديم وتم برمجته  ✳️
[FFFFFF]✳️ تم تعديل الكثير من الأيبات بواستطي ✳️
[FFFFFF]✳️ السورس مسرب ومجاني للجميع ✳️
⚠️✳️ الصانع ✳️⚠️
[FF00FF] DLJ comeantary BOT ⚔️
★☆★☆★☆★☆★"""
                        ...
                        if inPuTMsG.strip().startswith('@ma '):
                            ...
                            try:
                                ...
                                if len(parts) < 2:
                                    ...
                                    messages = [
                                        "يا {Name} انت أـخـو شـرمـوطـة ا ",
    "يا {Name} احط رجـلـي بـكـس اـمـك الملبلبة !",
    "ويا {Name} انـيـج عشيرتك واحد واحد ",
    "يا {Name} روحي تعال مـص هو هاذ شغلك يا قـحـبتي ",
    "{Name} واـخـتك الشـرمـوطة لي بعدها تنناك فتحتها وصارت حامـل 9 أشهر ",
    "يا {Name} وعيـري هذا حطيطته حتى بكـس خالاتك",
    "يا {Name} واركع يا قحـبتي بدون حكي",
    " يا{Name} ومـص ولا تحكي ولاك ়",
    "{Name} امـك البارحة جانت تكول آ.ه آه هسه تجي يمي تحجي !",
    "{Name} لا تخليني افتحك انت هم مثل ابوك",
    "{Name} هو انت واحد شـرمـوطة مثل اهلك ",
    "{Name} تحب تـتـناكون كثير",
    "{Name} شكد حلو من تكول آه آ.ه",
    "{Name} خليتك تكول ارحمني يا بوت واذا ما جنت بوت شجنت تسوي ",
    "{Name} وانت واحد G A _ Y",
    "انيـجك يا {Name} و تحياتي للباقي ",
    "{Name} DLJ comeantary BOT ⚔️"
                                            ]
...
[FFFFFF]Example: /bundle midnight"""
                        ...
                        if inPuTMsG.strip().lower() in ("5", "@help", "hi", "hello", "5"):
                            ...
                            basic = """[c][b]⚔️[00FFFF]★☆★ DLJ Kirkuki ★☆★[FFD700]⚔️
[B][FF0000]★☆★☆★☆★☆★☆★☆
...
[B][FF0000]★☆★☆★☆★☆★☆★☆"""
                            ...
                            emotes = """[c][b]⚔️[FF00FF] ★☆★ [00FFFF]DLJ Kirkuki[FF00FF]★☆★⚔️
[B][FF0000]★☆★☆★☆★☆★☆★☆
...
[B][FF0000]★☆★☆★☆★☆★☆★☆"""
                            ...
                            evo = """[c][b]⚔️[FF0000]★☆★ [FFFF00]DLJ Kirkuki [FF0000]★☆★ ⚔️
[B][FF0000]★☆★☆★☆★☆★☆★☆★☆
...
[B][FF0000]★☆★☆★☆★☆★☆★☆★☆"""
                            ...
                            spam_cmnd = """[c][b]⚔️[00BFFF]★☆★[FFFFFF]DLJ Kirkuki[00BFFF]★☆★ ⚔️
[00BFFF]★☆★☆★☆★☆★☆★☆
...
[B][00BFFF]★☆★☆★☆★☆★☆★☆★☆"""
                            ...
                            badge_cmnd = """[c][b]⚔️[00FFFF]★☆★[FFFF00]DLJ Kirkuki[00FFFF]★☆★⚔️
...
[B][FF0000]★☆★☆★☆★☆★☆★☆★☆"""
                            ...
                            ad_cmnd = """[B][FF1493]★☆★⚠️Soc ; tele : @dljyta , Instagram : @dljyta , TIKTOK : @dljyta , YouTube: @dljyta ⚠️★☆★
[B][FF0000]★☆★☆★☆★☆★☆★☆
...
[00FFFF]★☆★☆★☆★☆★☆★☆
[00FFFF]✳️ المبرمج ✳️[FFFFFF]⚔️ DLJ comeantary ⚔️
[00FFFF]✳️⚠️ السورس مسرب ومجاني للجميع ⚠️✳️
[00FFFF]✳️ يويتوب ✳️[FFFF00]@dljyta
[00FFFF]✳️ تيكتوك ✳️[FFFFFF]@dljyta
[00FFFF]✳️ انستجرام ✳️[FFFFFF]@dljyta
[00E5FF]✳️ تليجيرام ✳️[00FFFF]@dljyta
[FF0000]★☆★☆★☆★☆★☆★☆"""
...
async def MaiiiinE():
    ...
    os.system('clear')
    print("=" * 50)
    print("DLJ comeantary BOT ~ INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("DLJ comeantary BOT ~ STARTING")
    print("=" * 50)
    ...
    os.system('clear')
    print("=" * 50)
    print("DLJ comeantary BOT ~ ONLINE")
    print("=" * 50)
    print(f"🔹 UID: {TarGeT}")
